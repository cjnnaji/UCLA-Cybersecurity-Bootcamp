...
2. Next, have the students log in to Sguil to verify that their PCAPs are still populated. Remind students that their Sguil login credentials are:
...
- Click on the Squert desktop icon and enter the same credentials you used for your Sguil login.
